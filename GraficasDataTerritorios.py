...
birthsCiudadJardin = [230,210,243,210,245,217,262,263,264,274,293,301,296]
...
#plt.plot(year, birthsCiudadJardin, label = 'Zona Ciudad Jardín', linewidth = 3, color = 'yellow')


# Definición de título y nombres de ejes
plt.title('Numero de nacimientos zonas norte, oeste y sur entre 2005-2017')
